...
<div class="container-fluid">
  <div class="container">
    ...
    if($con) {
      ...
      // Connection error, set default values
      $pharmacy_name = "";
      $address = "";
      $email = "";
      $contact_number = "";
      ...
      <div class="row col col-md-6">
        ...
        <div class="row col col-md-12">
          <div class="col col-md-12 form-group">
            <label class="font-weight-bold" for="pharmacy_name">Name:</label>
            <input id="pharmacy_name" type="text" class="form-control" value="<?php echo $pharmacy_name; ?>" placeholder="Name" onkeyup="validateName(this.value, 'pharmacy_name_error');" disabled>
