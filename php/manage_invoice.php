  ...
  function printInvoice($invoice_number) {
    ...
    <div class="row">
      ...
      <div class="col-md-4">
        ...
        <span class="font-weight-bold">Warehouse's Name : </span><?php echo $doctor_name; ?><br>
        <span class="font-weight-bold">Warehouse's Address : </span><?php echo $doctor_address; ?><br>
      </div>
